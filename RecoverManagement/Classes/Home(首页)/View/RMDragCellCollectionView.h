...
@class RMDragCellCollectionView;

@protocol  RMDragCellCollectionViewDelegate<UICollectionViewDelegate>
@required
/**
 ...
 *  某个cell正在移动的时候
 */
- (void)dragCellCollectionViewCellisMoving:(RMDragCellCollectionView *)collectionView;
/**
 ...
 *  cell双击，想要改变大小的时候调用
 */
- (void)doubleTapCellCollectionView:(RMDragCellCollectionView *)collectionView tapCellIndexPath:(NSIndexPath *)fromIndexPath;
/**
 *  成功交换了位置的时候调用
 *  @param fromIndexPath    交换cell的起始位置
 *  @param toIndexPath      交换cell的新位置
 */
- (void)dragCellCollectionView:(RMDragCellCollectionView *)collectionView moveCellFromIndexPath:(NSIndexPath *)fromIndexPath toIndexPath:(NSIndexPath *)toIndexPath;
@end
@protocol  RMDragCellCollectionViewDataSource<UICollectionViewDataSource>
@required
/**
...
@interface RMDragCellCollectionView : UICollectionView

@property (nonatomic, assign) id<RMDragCellCollectionViewDelegate> delegate;
@property (nonatomic, assign) id<RMDragCellCollectionViewDataSource> dataSource;
...
/**是否正在编辑模式，调用rm_enterEditingModel和rm_stopEditingModel会修改该方法的值*/
