...
@interface WillTodoLeaveViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UIView *headerV;
...
@implementation WillTodoLeaveViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLB.text = @"我的待办-请假审批";
    [self addLeftView:@""];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (willOrDoneTag ==0) {
        nameArr = @[@"李四请假",@"王五请假"];
        timeArr = @[@"2015-08-23  09：00-18：00",@"2015-08-23  09：00-18：00"];
        model = dataArr[indexPath.row];
    }else{
        nameArr = @[@"佳佳请假",@"Monica请假",@"佳佳请假",@"Monica请假"];
        timeArr = @[@"2015-08-23  09：00至2016-08-24  18：00",@"2015-08-23  09：00-18：00",@"2015-08-23  09：00至2016-08-24  18：00",@"2015-08-23  09：00至2016-08-24  18：00"];
        shenpiArr = @[@"1",@"0",@"1",@"1"];
    }
