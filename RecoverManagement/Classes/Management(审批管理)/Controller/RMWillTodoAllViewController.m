...
@interface RMWillTodoAllViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UIView *headerV;
...
@implementation RMWillTodoAllViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLB.text = @"我的待办-全部";
    [self addLeftView:@""];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.hidesBottomBarWhenPushed = YES;
    vc.state = [sectionTitleArr[indexPath.section] substringToIndex:2];
    [self.navigationController pushViewController:vc animated:YES];
}
