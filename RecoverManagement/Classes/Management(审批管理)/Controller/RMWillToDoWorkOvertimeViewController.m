//
//  RMWillToDoWorkOvertimeViewController.m
//  RecoverManagement
//
...
@interface RMWillToDoWorkOvertimeViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UIView *headerV;
...
@implementation RMWillToDoWorkOvertimeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLB.text=@"我的待办-加班审批";
    [self addLeftView:@""];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (willOrDoneTag ==0) {
        nameArr = @[@"李四加班",@"王五加班"];
        timeArr = @[@"2015-08-23  18：00-21：00",@"2015-08-23  18：00-20：00"];
        model = dataArr[indexPath.row];

    }else{
        nameArr = @[@"佳佳加班",@"Monica加班",@"佳佳加班",@"Monica加班"];
        timeArr = @[@"2015-08-23  18：00-19：00",@"2015-08-23  18：00-22：00",@"2015-08-23  18：00-20：00",@"2015-08-23  18：00-21：00"];
        shenpiArr = @[@"1",@"0",@"1",@"1"];
