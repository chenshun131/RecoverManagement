...
#import "RMTurnOnViewController.h"
...
@interface RMTurnOnViewController ()<UITextViewDelegate,UIScrollViewDelegate,UINavigationControllerDelegate,UIGestureRecognizerDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
>
{
...
@implementation RMTurnOnViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLB.text = [NSString stringWithFormat:@"%@审批-转审",_state];
    [self addLeftView:@""];
...
- (void)setView{
    ...
    UIView *nowApproverView  = [[UIView alloc]initWithFrame:CGRectMake(0,10, KScreenWidth, 85)];
    nowApproverView.backgroundColor = [UIColor whiteColor];
    nowApproverView.userInteractionEnabled = YES;
    [backgroundScrollView addSubview:nowApproverView];
    
    UILabel *nowApproverLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 35, 150, 15)];
    nowApproverLabel.text=@"当前步骤审批人";
    nowApproverLabel.font = [UIFont systemFontOfSize:16];
    [nowApproverView addSubview:nowApproverLabel];
    ...
    //collectionCell的注册
    [approverCollectionView registerClass:[RMApproverCollectionViewCell class] forCellWithReuseIdentifier:@"myheheIdentifier2"];
    [nowApproverView addSubview:approverCollectionView];
    
    omitLabel = [[UILabel alloc]initWithFrame:CGRectMake(KScreenWidth-30, 35, 20, 20)];
    omitLabel.text = @"...";
    [nowApproverView addSubview:omitLabel];
    omitLabel.hidden = YES;

    
    UILabel *hintLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(nowApproverView.frame), KScreenWidth-20, 30)];
    ...
    UIView *yijianView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(hintLabel.frame), KScreenWidth, 150)];
    ...
    UILabel *yijianLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 15, 100, 15)];
    yijianLabel.text = @"转审意见";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    RMApproverCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"myheheIdentifier2" forIndexPath:indexPath];
